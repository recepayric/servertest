...
func NewMux() http.Handler {
	...
	r := &router{
		routes: map[string]http.HandlerFunc{
			...
			"PUT /api/zikirs/custom":                  handlers.CustomZikirUpdate,
			...
			"GET /api/cloud/profile":                  handlers.CloudProfileGet,
			"POST /api/cloud/profile/delta":           handlers.CloudProfileDelta,
			"GET /api/cloud/daily":                    handlers.CloudDailyGet,
			"POST /api/cloud/daily/upsert":            handlers.CloudDailyUpsert,
			"GET /api/cloud/zikir-progress":           handlers.CloudZikirProgressGet,
			"POST /api/cloud/zikir-progress/upsert-batch": handlers.CloudZikirProgressUpsertBatch,
			"GET /api/cloud/achievements":             handlers.CloudAchievementsGet,
			"POST /api/cloud/achievements/upsert-batch": handlers.CloudAchievementsUpsertBatch,
